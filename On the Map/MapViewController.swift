...
class MapViewController: NavBarButtonController, MKMapViewDelegate {
    ...
    func hardCodedLocationData() -> [ParseStudentLocation] {
        return  ParseStudentLocation.studentLocationFromResults([
            [
